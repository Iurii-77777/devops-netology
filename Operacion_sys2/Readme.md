...
## **Последнее сообщение dmesg [11435.179933] cgroup: fork rejected by pids controller in /user.slice/user-1000.slice/session-3.scope**
## **Закончились pid(потоки) для новых процессов. **
